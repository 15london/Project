                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="fh-contact-box type-address "><i class="flaticon-pin"></i>
                                    ...
                                    <div class="desc">
                                        <p>15 Thomas More St, St Katharine's & Wapping,
                                             London E1W 1YW, United Kingdom </p>
                                    </div>
                                    <div class="desc">
                                        <p>Germany Office: Willy Brandt StraBe, 40, 2047 Hamburg Germany<br>
                                        </p>
                                    </div><br>
									<div class="desc">
                                        <p>Turkey Office: Levent, Ebulula Mardin Cd. Maya Siteleri L 1, 34338 Beşiktaş/İstanbul, Turkey </p>
                                    </div><br>
									<div class="desc">
                                        <p>Dubia Office: 3B St - Al Quoz - Dubai - United Arab Emirates . </p>
                                    </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="fh-contact-box type-phone "><i class="flaticon-phone-call "></i>
                                    ...
                                    <div class="desc">
                                        <p>Office: +44 (0) 20 80403689<br>
                                        Fax: +44 (0) 20 80403690
</p>
                                    </div>
									
									<div class="desc">
                                        <p>German Office: +49 1573 5980520<br>
                                        
</p>
                                    </div>
                                </div>
                                <div class="fh-contact-box type-social "><i class="flaticon-share"></i>
                                    <h4 class="box-title">We are socia</h4>
                                    <ul class="clearfix">
                                        <li class="facebook">
...
<!-- Mirrored from steelthemes.com/demo/html/cargohub_theme/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Jul 2018 14:44:17 GMT -->
</html>