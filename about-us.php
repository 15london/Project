...
<head>
    <meta charset="utf-8">
    <title>Welome to SG8 Vault Services</title>
    <!-- Stylesheets -->
                    ...
                    <div id="cargo-office-location-widget-2" class="widget cargo-office-location-widget">
                        <div class="office-location clearfix">
                            ...
                            <ul class="topbar-office active">
                                <li><i class="flaticon-telephone" aria-hidden="true"></i>+49 1573 5980520</li>
                                <li><i class="flaticon-web" aria-hidden="true"></i>info@sg8valutservices.com</li>
                                <li><i class="flaticon-pin" aria-hidden="true"></i>Willy Brandt straBe, 40 20457 Hamburg</li>
                            </ul>
                ...
                <div class="container mobile_relative">
                    <div class="row">
                        <div class="site-logo col-md-3 col-sm-6 col-xs-6">
                            ...
                            <h1 class="site-title"><a href="#">SG8 Vault Services</a></h1>
                            <h2 class="site-description">Welome to SG8 Vault Services</h2>
                        </div>
                                ...
                                <ul class="menu">
                                    ...
                                    <li><a href="index.php">Home</a></li>
                                     ...
                                     <li><a href="about-us.php">About us</a></li>
                                      ...
                                      <li><a href="track.php">Online Tracking</a></li>
                                    ...
                                    <li class="extra-menu-item menu-item-button-link">
                                        <a href="contact.php" class="fh-btn btn">Get A Quote</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="abotimglft">
                            <!--<img src="images/resources/aboutus-1.jpg" class="img-responsive">-->
                        </div>
                    </div>
                    <div class="col-md-8 col-sm-6">
                        <div class="abotinforgt">
                            ...
                            <p>SG8 Vaults Services is mostly been managed by well known expertise both locally and intentionally. SG8 Vaults Services  is one of the leading secuirty agency in the country as at now. The management team are members with more than 12 years of great working and industry experiences. All the members of the development team are committed towards delivering of some services such as parcel delivery, mining and other consultation related services, we also challenge ourselves to improve performance year by year and to create long-term sustainability .

SG8 Vaults Services  is also well equipped with all the necessary technical know-how personnel and logistics facilities to effectively and efficeintly excute tedious works and also to see to the day to day activites of the company and our also client. We always take care to employ the best people, develop their competence, provide opportunity and inspire them to live our values.
we always demonstrate the utmost care and respect for those people whose welfare and safety is entrusted to us. 

We have close and open relationships with our customers that generate trust and we work in partnership for the mutual benefit of our organisations and also always be trusted to do the right thing.</p>
                            <img class="paddtop20" src="images/icon/signature-1.png" alt="" /><br> C.E.O
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-md-offset-2">
                        <div class="fh-icon-box  style-2 version-dark  icon-center">
                            ...
                            <div class="desc">
                                <p>We give maximum attention to every little details of goods</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                ...
                <div class="fh-team">
                    <div class="team-list slideteam">
                        <div class="team-member ">
                            <div class="team-header"><img src="images/team/team-1.jpg" class="attachment-full" alt="" />
                        ...
                        <div class="team-member ">
                            <div class="team-header"><img src="images/team/team-2.jpg" class="attachment-full" alt="" />
                                <ul class="team-social">
                                    <li><a href="#" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="#" target="_blank"><i class="fa fa-skype"></i></a></li>
                        ...
                        <div class="team-member ">
                            <div class="team-header"><img src="images/team/team-3.jpg" class="attachment-full" alt="" />
                                <ul class="team-social">
                                    <li><a href="#" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="#" target="_blank"><i class="fa fa-skype"></i></a></li>
                        ...
                        <div class="team-member ">
                            <div class="team-header"><img src="images/team/team-4.jpg" class="attachment-full" alt="" />
                                <ul class="team-social">
                                    <li><a href="#" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="#" target="_blank"><i class="fa fa-skype"></i></a></li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="contact col-md-3 col-xs-12 col-sm-12"><i class="flaticon-signs"></i>
                            <p>Address :</p>
                            <h4>15 Thomas More St, St Katharine's &amp; Wapping,
London E1W 1YW, United Kingdom</h4></div>
                        <div class="contact col-md-3 col-xs-12 col-sm-12"><i class="flaticon-phone-call "></i>
                            <p>Contact:</p>
                            <h4>+49 1573 5980520</h4></div>
                        ...
                        <div class="footer-sidebar footer-1 col-xs-12 col-sm-6 col-md-3">
                            <div class="widget widget_text">
                                ...
                                <div class="textwidget">
                                    <p>SG8 is more than logistics. 
We can also optimize your packaging, manage your materials sourcing, and so much more.managed by well known expertise both locally and intentionally</p>
                                </div>
                            </div>
                            <div class="widget cargohub-social-links-widget">
                                <div class="list-social style-1">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-copyright col-md-6 col-sm-12 col-sx-12">
                        <div class="site-info">Copyright &#9400; 2017 <a href="#">SG8 Vaults Services</a>, All Right Reserved </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12 text-right footer-text"><a href="#"></a> </div>
                </div>
            </div>
        </footer>
        <!--copyright sec end-->
    ...
    <div class="primary-mobile-nav header-v1" id="primary-mobile-nav" role="navigation">
        ...
        <ul class="menu">
                   ...
                   <li class=""><a href="index.php" class="dropdown-toggle">Home</a>
                                     ...
                                     <li class="has-children"><a href="about-us.php" class="dropdown-toggle">About Us</a></li>
                                     <li><a href="services.php">Our Services</a></li>
                                       <li><a href="track.php">Online Tracking</a></li>
...
<!-- Mirrored from steelthemes.com/demo/html/cargohub_theme/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Jul 2018 14:42:45 GMT -->
</html>