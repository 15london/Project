...
<form action="view.php" method="post" name="addtrack">
  <table width="400" border="0" align="center" cellpadding="0" cellspacing="3">
    <tr>
      ...
      <td width="53%"><label>
        <input name="user" type="text" class="border" id="user" size="25">
      </label></td>
    </tr>
    <tr>
      <td class="style13"><span class="style13">Password :</span></td>
      <td><input name="pass" type="text" class="border" id="pass" size="25"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><label>
        <input name="adminbtn" type="submit" class="txtbutton" id="adminbtn" onclick="MM_validateForm('user','','R','pass','','R');return document.MM_returnValue" value="Add Administrator">
      </label></td>
    </tr>
  </table>
</form>
