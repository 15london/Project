...
<?php
				  ...
				  $addadmin = mysql_query("select * from contactdetails where id = '$id'");
				if(!$addadmin){
...
<option value="Afghanistan">Afghanistan </option>
    ...
    <tr>
      ...
      <td><label>
        <textarea name="address" rows="4" class="bordertxtarea" id="address"><?php echo $address;?>
        </textarea>
      </label></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="tele1" type="text" class="border" id="tele1" value="<?php echo $tele1;?>" size="25"></td>
    </tr>
    <tr>
      <td><span class="style13">Telephone 2</span></td>
      <td><input name="tele2" type="text" class="border" id="tele2" value="<?php echo $tele2;?>" size="25"></td>
    </tr>
    <tr>
      <td class="style13">Email Adress</td>
      <td><input name="email" type="text" class="border" id="email" value="<?php echo $email;?>" size="25" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input name="updatecontbtn" type="submit" class="txtbutton" id="updatecontbtn" value="Update" /></td>
    </tr>
  </table>
</form>
