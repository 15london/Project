...
<body class="home header-transparent  header-sticky header-v1 hide-topbar-mobile">
    <div id="page">
        ...
        <div class="welcomesec secpadd">
            <div class="container">
                <div class="fh-section-title clearfix  text-center version-dark paddbtm20">
                    <h2>Welcome to SG8 <span class="main-color">Vaults Services</span></h2>
                </div>
                <p class="haeadingpara text-center paddbtm40">SG8  is more than logistics.
                    <br/> We can also optimize your packaging, manage your materials sourcing, and so much more.managed by well known expertise both locally and intentionally</p>
                ...
                <div class="welservices row">
                    <div class="col-md-4 col-sm-6">
                        <div class="fh-icon-box icon-type-theme_icon style-1 version-dark hide-button icon-left">
                            ...
                            <div class="desc">
                                <p>As a leader in global air freight forwarding, SG8  Global excels in providing tailored transportation</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                ...
                <div class="row paddbtm40">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <div class="hdrgtpara lftredbrdr">
                            <p>Our vaults services are known nationwide to be one of the most reliable, safe and affordable, because we take pride in delivering the best of vaults services, at the most reasonable prices.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <section class="homecounts">
            <div class="container">
                <h2 class="count-title">SG8 <span class="main-color">vaults</span> is a Global Supplier of Transport and logistics Solutions.</h2>
                <div class="row">
                            ...
                            <div class="fh-form-1 fh-form">
                                <div class="row fh-form-row">
                                    <div class="col-md-6 col-xs-12 col-sm-12">
                                        <p class="field">
                                            <input name="delivery-city" value="" placeholder="Source City*" type="text">
                                        </p>
                                    </div>
                                    <div class="col-md-6 col-xs-12 col-sm-12">
                                        <p class="field">
                                    ...
                                    <div class="col-md-6 col-xs-12 col-sm-12">
                                        <p class="field">
                                            <input name="distance" value="" placeholder="Item Type*" type="text">
                                        </p>
                                    </div>
                                    <div class="col-md-6 col-xs-12 col-sm-12">
                                        <p class="field">
    ...
    <div class="primary-mobile-nav header-v1" id="primary-mobile-nav" role="navigation">
        ...
        <ul class="menu">
                   ...
                   <li class=""><a href="index.php" class="dropdown-toggle">Home</a>
                                     ...
                                     <li><a href="services.php">Our Services</a></li>
                                       <li><a href="track.php">Online Tracking</a></li>
                                       <li><a href="track.php">Track Deposit</a></li>
